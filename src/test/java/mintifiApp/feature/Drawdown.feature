...
# calling genrate csrf secanrio from registred.feature
        * def fetchGenrateCsrfScenario = call read('ExecutionHelper/drawdownlogin.feature@generateid')
...
# Define the invoice form data
        ...
        And multipart field loanApplicationId = '66832'
